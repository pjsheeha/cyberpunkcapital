...
let chap1sect1 = {
  ...
  text:[
    {text:'1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',
      altText: '<p>Ok, who the hell are these gonks? Apparently Ferdie Lasalle wrote this pamphlet called The Open Reply Letter. This was some hate mail to the bourgy Progressist Party (which was run by the other guy mentioned), sayin&rsquo; that they were being a bunch of Puppets for the system, and he&rsquo;s tryin&rsquo; to cancel &lsquo;em, agitate, whatevs.&nbsp; Apparently though, there&rsquo;s a hint Ferdie was a total kleptoid for Marx&rsquo;s work, tryin&rsquo; to change it up a bit to make it super smooth for a prole to jack into *without* chippin&rsquo; Marx in. Marx doesn&rsquo;t really care, except apparently Fernie got some real essential shit wrong!&nbsp;</p>'}
  ]
...
let chap1sect2 = {
  ...
  header: "1.2. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    {text:'1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',
      altText: 'This is commentary.'}
  ]
};
let chap1sect3 = {
  name: "chapter1-sect3",
  ...
  title: "Chapter 1: Commodities",
  header: "1.3. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},  
  ]
};
let chap1sect3A = {
  name: "chapter1-sect3a",
  sectHeader: "1.3.A. Simple, Isolated, or Accidental Form of Value",
  title: "Chapter 1: Commodities",
  header: "1.3.A The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},  
  ]
};
let chap1sect3B = {
  name: "chapter1-sect3b",
  sectHeader: "1.3.B. Simple, Isolated, or Accidental Form of Value",
  title: "Chapter 1: Commodities",
  header: "1.3.B. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},  
  ]
};
let chap1sect3C = {
  name: "chapter1-sect3c",
  sectHeader: "1.3.C. General Form of Value",
  title: "Chapter 1: Commodities",
  header: "1.3.C. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},  
  ]
};
let chap1sect3D = {
  name: "chapter1-sect3d",
  sectHeader: "1.3.D. Money Form",
  title: "Chapter 1: Commodities",
  header: "1.3.D. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},  
  ]
};
let chap1sect4 = {
  name: "chapter1-sect4",
  sectHeader: "1.4. Fetish-Like Character and its Secret",
  title: "Chapter 1: Commodities",
  header: "1.4. The Two-fold Character of the Labour Embodied in Commodities",
  text:[
    { text: '1. This is the more necessary, as even the section of Ferdinand Lassalle’s work against Schulze-Delitzsch, in which he professes to give “the intellectual quintessence” of my explanations on these subjects, contains important mistakes. If Ferdinand Lassalle has borrowed almost literally from my writings, and without any acknowledgement, all the general theoretical propositions in his economic works, e.g., those on the historical character of capital, on the connexion between the conditions of production and the mode of production, &c., &c., even to the terminology created by me, this may perhaps be due to purposes of propaganda. I am here, of course, not speaking of his detailed working out and application of these propositions, with which I have nothing to do.',altText: 'This is commentary.'},
...
//{id: ['1'], heading1Tag: ['A-Elementary-or-Accidental-Form-Of-Value'], heading1:  }
let chap1footnotes = {
